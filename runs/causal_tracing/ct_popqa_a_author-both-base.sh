...
#SBATCH --job-name=ct-a-popqa-author
#SBATCH --error=./logs/ct-a-popqa-author-base-%J.err.log
#SBATCH --output=./logs/ct-a-popqa-author-base-%J.out.log
...
OUTPUT_DIR=./experiments/popqa/a/matched-both-repr-base/author
