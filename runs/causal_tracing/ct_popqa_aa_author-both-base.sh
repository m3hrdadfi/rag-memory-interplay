...
#SBATCH --job-name=ct-aa-popqa-author
#SBATCH --error=./logs/ct-aa-popqa-author-base-%J.err.log
#SBATCH --output=./logs/ct-aa-popqa-author-base-%J.out.log
...
OUTPUT_DIR=./experiments/popqa/aa/matched-both-repr-base/author

ATTRIBUTES="obj=context" 
ATTRIBUTES_NOISE="subj=subj_cf_emb,obj=obj_cf_emb"
