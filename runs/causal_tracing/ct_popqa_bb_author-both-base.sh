...
#SBATCH --job-name=ct-bb-popqa-author
#SBATCH --error=./logs/ct-bb-popqa-author-base-%J.err.log
#SBATCH --output=./logs/ct-bb-popqa-author-base-%J.out.log
...
OUTPUT_DIR=./experiments/popqa/bb/matched-both-repr-base/author
