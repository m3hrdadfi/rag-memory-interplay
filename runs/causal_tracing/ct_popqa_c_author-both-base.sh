...
#SBATCH --job-name=ct-c-popqa-author
#SBATCH --error=./logs/ct-c-popqa-author-base-%J.err.log
#SBATCH --output=./logs/ct-c-popqa-author-base-%J.out.log
...
OUTPUT_DIR=./experiments/popqa/c/matched-both-repr-base/author
