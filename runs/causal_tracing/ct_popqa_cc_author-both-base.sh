...
#SBATCH --job-name=ct-cc-popqa-author
#SBATCH --error=./logs/ct-cc-popqa-author-base-%J.err.log
#SBATCH --output=./logs/ct-cc-popqa-author-base-%J.out.log
...
OUTPUT_DIR=./experiments/popqa/cc/matched-both-repr-base/author
...
REVERSED_ATTRIBUTES_NOISE=7.133796215057373
DISABLE_MLP_ATTN=1

echo "EXPERIMENT (cc): ${OUTPUT_DIR}"
