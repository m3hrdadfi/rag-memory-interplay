...
def average_substring_accuracy(predictions, ground_truths_list, normalize_fn: Callable[[str], str] = lambda x: x):
    ...
    assert len(predictions) == len(
        ground_truths_list
    ), "Length of predictions and ground_truths_list must be the same."
