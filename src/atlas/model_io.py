...
from . import dist_utils, fid
from .atlas import Atlas
from .retrievers import Contriever, DualEncoderRetriever, UntiedDualEncoderRetriever
from .util import cast_to_precision, set_dropout, set_optim
...
def load_reader(opt):
    ...
    if not opt.retrieve_only:
        reader = fid.FiD.from_pretrained(opt.reader_model_type)
