...
from atlas.evaluation import average_substring_accuracy, exact_match_score, f1_score, normalize_answer
from atlas.options import Options
from atlas.tasks.base import BaseTask


class Task(BaseTask):
    metrics = ["exact_match", "f1", "avg_sub_acc", "eval_loss"]
    ...
    def evaluation(self, prediction, ground_truths):
        sample_metrics = {
            ...
            "avg_sub_acc": average_substring_accuracy(prediction, ground_truths, normalize_answer),
        }
